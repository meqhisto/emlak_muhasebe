...
const PersonnelPage: React.FC = () => {
  ...
  const { personnel, payments, expenses, addPersonnel, updatePersonnel, addPayment, addExpense, refreshLogs } = useData();
  ...
  const handlePaymentSubmit = (e: React.FormEvent) => {
    ...
    // For now the add actions will log their own standard messages.
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left text-sm">
                ...
                <tbody className="divide-y divide-slate-100">
                  {payments && payments.sort((a, b) => b.date.localeCompare(a.date)).map(pay => {
